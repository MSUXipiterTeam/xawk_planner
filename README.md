...
```
cd ~/workspace
git clone https://github.com/MSUXipiterTeam/xawk_planner.git
```

3) Build Xawk Planner:

```
cd ~/workspace/xawk_planner
...
5) Permanent installation (optional, if you'd like to install Xawk Planner in a fixed location)
